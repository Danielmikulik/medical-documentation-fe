...
export default function DashboardDefault() {
    ...
    useEffect(() => {
        api.get(`/api/hospital/count`, {
            headers: {
                Authorization: `Bearer ${cookies.token}`
            }
        }).then((res) => {
            setHospitalCount(res.data.toString());
        });
    }, []);
    ...
    return (
        <Grid container rowSpacing={4.5} columnSpacing={2.75}>
            ...
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <DashboardCard title="Počet lekárov" count={doctorCount} />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <DashboardCard title="Počet nemocníc" count={hospitalCount} />
            </Grid>
